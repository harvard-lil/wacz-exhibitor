...
- Upgrade to `<replay-web-page>` 1.7.0
...
- Removed logic to automatically append `noCache` for browsers that do not support the storage manager API, now handled by `<replay-web-page>` directly.
